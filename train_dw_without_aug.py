    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                best_acc = epoch_acc
                best_model_wts = model.state_dict()
                torch.save(best_model_wts, 'checkpoint_dw_without_aug_model.pth')
...
dataset_val = NCKUFinalDataset(txt_file="/ssd4/ming/final/final/test.txt", transform=data_transforms['val'])
test_loader = DataLoader(test_dataset, batch_size=1, shuffle=False)




torch.save(model.state_dict(), 'best_dw_without_aug_model.pth')
